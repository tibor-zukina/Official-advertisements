...
if ( isset($_SESSION["authTokenAdmin"]) ) {
    ...
    $stmt->prepare("SELECT IdUser, EmailUser, NameUser, SurnameUser, CompanyUser, WhatsAppNumberUser, AddressUser , CountryUser , ImageUrlUser, DocumentImageUrlUser, StatusUser, HashUser FROM Usr WHERE DeletedUser LIKE 'yes' ");
    $stmt->execute();
