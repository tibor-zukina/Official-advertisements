    ...
    if (text.replace(/(\r\n|\n|\r)/gm,"") == "") {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                spinner.stop();
                if(success==1) {
                    swal('Instructions successfully updated', 'You have successfully updated the instructions for your users', 'success');
...
function deleteInstruction() {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                spinner.stop();
                if(success==1) {
                    swal('Instructions successfully deleted', 'You have successfully deleted the instructions for your users', 'success');
                    setTimeout(function(){ window.history.back(); }, 1500);
                }
                else if (success == -666) window.location.href = 'logout.php';
            },
