...
multiple size=5  id="country"  class="countrySelect" >
        <option value="Afghanistan" selected>Afghanistan
        ...
        <option value="Cayman Verde">Cayman Verde
        ...
        <option value="Trinidad and Tobiago">Trinidad and Tobiago
        ...
        <option value="United States Minor Islands">United States Minor Islands
