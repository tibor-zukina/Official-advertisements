...
if ( isset($_SESSION["authTokenAdmin"]) ) {
    ...
    $stmt->prepare("SELECT IdUser, EmailUser, NameUser, SurnameUser, CompanyUser, WhatsAppNumberUser, AddressUser , CountryUser , ImageUrlUser, DocumentImageUrlUser, StatusUser, HashUser FROM Usr WHERE StatusUser LIKE 'free' AND DeletedUser LIKE 'no' ");
    $stmt->execute();
