...
if (isset($_POST['title']) && isset($_POST['text']) && isset($_POST['time']) && isset($_SESSION['authTokenAdmin']) && isset($_SESSION['adminId']) ) {
    ...
    $stmt->prepare("INSERT INTO Instructions(TitleInstructions, TextInstructions, AdminIdInstructions, TimeInstructions, TypeInstructions, AuthTokenInstructions) VALUES(?,?,?,?,'video',?)");
    ...
    $response["success"] = 1;
    $response["message"] = "Video successfully put";    
