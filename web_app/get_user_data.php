...
if (isset($_SESSION["authTokenUser"]) && isTokenValid($_SESSION["authTokenUser"])) {
    ...
    $stmt = $mysqli->stmt_init();
    $stmt->prepare("SELECT EmailUser, NameUser, SurnameUser, CompanyUser, WhatsAppNumberUser, AddressUser, FacebookProfileUrlUser, CountryUser, ImageUrlUser, DocumentImageUrlUser, BalanceUser, StatusUser FROM Usr WHERE IdUser LIKE ?");
    $stmt->bind_param("s", $_SESSION['userId']);
    $stmt->execute();
    $stmt->bind_result($_SESSION["emailUser"], $_SESSION["nameUser"], $_SESSION["surnameUser"], $_SESSION["companyUser"], $_SESSION["whatsAppNumberUser"], $_SESSION["addressUser"], $_SESSION["facebookProfileUrlUser"], $_SESSION["countryUser"], $_SESSION["imageUrlUser"], $_SESSION["documentImageUrlUser"], $_SESSION["balanceUser"], $_SESSION["statusUser"]);
    $stmt->fetch();
    $stmt->close();
